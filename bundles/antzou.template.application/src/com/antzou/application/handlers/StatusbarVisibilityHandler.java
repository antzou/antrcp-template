...
public class StatusbarVisibilityHandler {
    ...
    public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell shell,
        ...
        // Find the statusbar (no casting needed)
        MUIElement statusbar = modelService.find("antzou.template.application.statusbar", window);
        if (statusbar != null) {
            statusbar.setVisible(!statusbar.isVisible());
            
            // 另一种查找菜单项的方法
    		List<MHandledMenuItem> menuItems = modelService.findElements(application, "window.appearance.hidestatusbar",
    		...
    		if (menuItem != null) {
    			...
    			String newLabel = currentLabel.equals("Hide Status Bar") ? "Show Status Bar" : "Hide Status Bar";
